...
class stopwatch(tk.Frame):
    ...
    def features(self): 
        ...
        self.start_time_button = tk.Button(self, text = "START", height = 5, width = 9, font=('ariel',19,"bold"), background="green", command = self.start_time)
        self.start_time_button.pack(side = tk.LEFT)

        self.stop_time_button = tk.Button(self, text = "PAUSE", height = 5, width = 9, font=('ariel',19,"bold"), background="red", command = self.pause_time)
        self.stop_time_button.pack(side = tk.LEFT)

        self.reset_time_button = tk.Button(self, text = "RESET", height = 5, width = 9, font=('ariel',19,"bold"), background="yellow", command = self.reset_time)
        self.reset_time_button.pack(side = tk.LEFT)

        self.quit_time_button = tk.Button(self, text = "QUIT", height=5, width = 9, font=('ariel',19,"bold"), background="blue", command = self.window.quit)
